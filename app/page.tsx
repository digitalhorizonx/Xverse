  ...
  return (
    ...
    <main id="main-content" className="relative min-h-screen overflow-x-clip bg-ink-950">
      ...
      <div className="relative">
        <section className="relative mx-auto flex max-w-4xl flex-col items-center gap-6 px-6 pb-8 pt-20 text-center">
          <div aria-hidden className="pointer-events-none absolute inset-0 bg-radial-glow-nebula" />

          <span className="glass relative inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-medium uppercase tracking-[0.2em] text-mist-300">
            HorizonX Digital Universe
          </span>

          <h1 className="relative font-display text-4xl font-semibold leading-tight text-mist-100 sm:text-6xl">
            Enter the <span className="text-gradient">HorizonX Universe</span>
          </h1>

          <p className="relative max-w-xl text-balance text-lg text-mist-400">
          ...
          <p className="relative text-xs uppercase tracking-[0.2em] text-mist-500">
